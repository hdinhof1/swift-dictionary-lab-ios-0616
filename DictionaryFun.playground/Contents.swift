...
var stateCapitals = ["New York" : "Albaby",
                     "Ohio" : "Columbus",
                     "Florida" : "Tallahassee",
                     "Georgia" : "Atlanta",
                     "Kentucky" : "Frankfort"]
 ...
 */
var capitalFL = stateCapitals["Florida"]
 ...
 */
// write your code here
if let capitalFL = capitalFL {
    print ("The capital of Florida is \(capitalFL)")
}
...
if let anotherCapital = anotherCapital {
    ...
    print ("I dont know Pennsylvanias capital")
}
 ...
 */
if let capitalPA = stateCapitals["Pennsylvania"] {
    print("Pennsylvania's capital is \(capitalPA)")
}
 ...
 */
let state = "New York"
if let capital = stateCapitals[state] {
 ...
 */
let bandWithMembers = [ "Nirvana":      ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                        "The Beatles":  ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                        "The Breeders": ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                        "Pixies":       ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
 ...
 */
let bandName = "Pixies"
var members = bandWithMembers[bandName]
